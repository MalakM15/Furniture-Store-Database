...
if __name__ == '__main__':
    print("=" * 50)
    print("AMIN Furniture Store - Database Management System")
    print("Student IDs: 1220031_1220871")
    print("=" * 50)
    print("\nStarting Flask application...")
    print("Make sure MySQL is running and the database 'amin_furniture' exists.")
    print("Import the SQL file (1220031_1220871.sql) to create the database schema.")
